...
(2, 'Information Science Engg'),
(3, 'Electronic and Communication Engg'),
(4, 'Electrical & Electronic Engg'),
(5, 'Civil Engg'),
...
-- (7, '1OX21IS101', 'STUDENT INSERTED', '2023-01-10 19:19:56'),
-- (8, '1OX21IS108', 'STUDENT UPDATED', '2023-01-10 19:20:31'),
-- (9, '1OX21IS123', 'STUDENT DELETED', '2023-01-10 19:21:23');
...
CREATE TABLE `teacher` (
  `t_id` INT UNSIGNED NOT NULL PRIMARY KEY,
...
CREATE TABLE `subjects` (
  `subcode` VARCHAR(10) NOT NULL PRIMARY KEY,
  `name` varchar(50) not null,
...
-- (1, 'john', 'john@gmail.com', 'pbkdf2:sha256:150000$1CSLss89$ef995dfc48121768b2070bfbe7a568871cd56fac85ac7c95a1e645c8806146e9');
